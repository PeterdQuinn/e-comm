...
import sty from "./PlasmicValue.module.css"; // plasmic-import: 4npco0bsljb91/css

import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: 8hrQuJEuqy1-X/icon
...
function PlasmicValue__RenderFunc(props: {
    ...
    () => [
      {
        path: "topBottom",
        type: "private",
        initFunc: ($props, $state, $ctx) => $props.topBottom
      },
      {
        path: "center",
        type: "private",
        initFunc: ($props, $state, $ctx) => $props.center
      },
      {
        path: "withButton",
        type: "private",
        initFunc: ($props, $state, $ctx) => $props.withButton
      }
    ],
    [$props, $ctx]
  );
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__aHQo, {
          [sty.freeBoxcenter__aHQOzLpTz]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxtopBottom__aHQot6F2F]: hasVariant(
            $state,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__wgM9)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg__oPmL)}
                role={"img"}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__qIatt, {
          [sty.freeBoxcenter__qIatTzLpTz]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxwithButton__qIatTiJrSh]: hasVariant(
            $state,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant($state, "withButton", "withButton") ? true : false) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__oRw8K, {
            [sty.freeBoxcenter__oRw8KzLpTz]: hasVariant(
              $state,
              "center",
              "center"
            ),
            [sty.freeBoxwithButton__oRw8KiJrSh]: hasVariant(
              $state,
              "withButton",
              "withButton"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Button
                className={classNames("__wab_instance", sty.button__hCyk, {
                  [sty.buttonwithButton__hCykiJrSh]: hasVariant(
                    $state,
                    "withButton",
                    "withButton"
                  )
                ...
                endIcon={
                  <RightArrowIcon
                    className={classNames(projectcss.all, sty.svg__uKrim)}
                    role={"img"}
                  />
                }
                rounded={true}
