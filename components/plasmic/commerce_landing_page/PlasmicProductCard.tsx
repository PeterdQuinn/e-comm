...
import Price from "../../Price"; // plasmic-import: QBm4GJW3D8ojm/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_commerce_landing_page.module.css"; // plasmic-import: dqttFxhDmHsNNwzjnwEK9t/projectcss
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: mzQtI5MDDprSU/css
    ...
    >
      ...
      >
        ...
        {(
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__tbYrl, {
              [sty.freeBoxsmall__tbYrlaBsL]: hasVariant(
                $state,
                "small",
                "small"
              )
        ...
        {(hasVariant($state, "small", "small") ? true : true) ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__yja4M, {
              [sty.freeBoxsmall__yja4MaBsL]: hasVariant(
                $state,
                "small",
                "small"
              )
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__fNvUb)}>
              {p.renderPlasmicSlot({
                defaultContents: (
              ...
              {p.renderPlasmicSlot({
                defaultContents: (
                  <Rating
                    className={classNames("__wab_instance", sty.rating__tfbwZ)}
                  />
                ),
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__m2VNi)}
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
