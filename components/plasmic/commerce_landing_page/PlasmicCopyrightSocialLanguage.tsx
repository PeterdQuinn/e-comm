...
import sty from "./PlasmicCopyrightSocialLanguage.module.css"; // plasmic-import: LKQHQItPtFY7n/css

import TwitterIcon from "./icons/PlasmicIcon__Twitter"; // plasmic-import: 0uB_LbHbnAMfk/icon
import MenuIcon from "./icons/PlasmicIcon__Menu"; // plasmic-import: 8C1PB62iWe1Ro/icon
import YoutubeIcon from "./icons/PlasmicIcon__Youtube"; // plasmic-import: ohAOv1dRnOK9o/icon
import PintrestIcon from "./icons/PlasmicIcon__Pintrest"; // plasmic-import: 26AzUmq1CIW_b/icon
import Icon15Icon from "./icons/PlasmicIcon__Icon15"; // plasmic-import: XHU9_urV4Kb62/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__bIty4)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___4IE3F)}
        >
          <div
          ...
          <div className={classNames(projectcss.all, sty.freeBox___0GeJd)}>
            <Button
              iconOnly={true}
              link={"http://twitter.com" as const}
              startIcon={
                <TwitterIcon
                  className={classNames(projectcss.all, sty.svg__dLbDq)}
                  role={"img"}
                />
              }
            />
            ...
            <Button
              className={classNames("__wab_instance", sty.button___6E8Ra)}
              iconOnly={true}
              link={"http://youtube.com" as const}
              startIcon={
                <YoutubeIcon
                  className={classNames(projectcss.all, sty.svg__ovQvV)}
                  role={"img"}
                />
              }
            />
            ...
            <Button
              className={classNames("__wab_instance", sty.button__fqWEr)}
              iconOnly={true}
              link={"http://pinterest.com" as const}
              startIcon={
                <PintrestIcon
                  className={classNames(projectcss.all, sty.svg___6Fu0M)}
                  role={"img"}
                />
              }
            />
        ...
        <Button
          className={classNames("__wab_instance", sty.button__nrYpW)}
          endIcon={
            <Icon15Icon
              className={classNames(projectcss.all, sty.svg__kV5Nv)}
              role={"img"}
            />
          }
          showEndIcon={true}
          startIcon={
            <Icon15Icon
              className={classNames(projectcss.all, sty.svg___4BvgJ)}
              role={"img"}
            />
          }
        >
